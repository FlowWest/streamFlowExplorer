...
setwd("data-raw")
knitr::include_graphics(path = "calsim_conceptual_diagram.pdf")
```
...
CalSim is developed in the form of a node-arc network where nodes represent specific locations and arcs represent flow between nodes: 
