...
* **Accessibility:** Outputs are public, open and accessible online. The machine learning model for estimating monthly unimpaired flows is not publicly accessible. However, the model used to calculate functional flow metrics based on these flows is published as [func-flow](https://github.com/leogoesger/func-flow) under the UC Davis [Environmental Flows Project](https://github.com/hrvg/ucd-eflow).
...
* **Monthly Dataset (California Unimpaired Flows Database)**[^zim23] [^zim17] [^gra22]: The core output of the Natural Flows project. A random forest model was used to predict unimpaired flows at a monthly timestep for all stream segments in California. 
...
[^gra22]: Grantham, T. E., Carlisle, D. M., Howard, J., Lane, B., Lusardi, R., Obester, A., Sandoval-Solis, S., Stanford, B., Stein, E. D., Taniguchi-Quan, K. T., Yarnell, S. M., & Zimmerman, J. K. (2022). Modeling functional flows in California’s rivers. *Frontiers in Environmental Science* 10. [https://doi.org/10.3389/fenvs.2022.787473](https://doi.org/10.3389/fenvs.2022.787473) 
...
Five categories of functional flow metrics are reported, based on the five flow components described by Yarnell et al, 2015[^yar15] and implemented in the [eFlows Functional Flow Calculator](https://eflows.ucdavis.edu/hydrology)[^lan24]. (Descriptive text from the Natural Flows application.)
