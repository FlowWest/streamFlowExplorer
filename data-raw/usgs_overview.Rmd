...
ggplot(usgs_overview, aes(x = min_date, xend = max_date, y = tributary, yend = tributary)) +
  geom_segment(size = 4, color = "gray") +
...
watersheds do not have any history of stream gaging. Less than half of the historically aged watersheds currently have active, publicly accessible gages today
