...
# Plot new complete data set. Color points by data type (gage, interpolated)
...
I am creating a regional model with data from 4 salmonid bearing streams: Butte Creek, Mill Creek, Deer Creek, and Yuba River . I am interested in flow data from 2000 - 2024 to match with my monitoring data. Unfortunately, on Yuba River, there is only gage data after _____. In order to keep Yuba in my dataset. I need to fill in the gaps. 
...
# NOTE _____ THIS IS AN EXAMPLE WITH TEMPERATURE, REDO this example with FLOW 
cdec_datasets("BCK") # Test out sensor 20 for flow data at BCK - 
...
butte_format <- butte |> 
    ...
    mutate(stream = "butte creek",
           gage_agency = "CDEC",
           gage_number = "BCK",
           parameter = "temperature") # TODO change to flow 
...
cdec_datasets("YR7") # NO flow so find different gage - if there is one on the yuba go for that 
# Gage Data
